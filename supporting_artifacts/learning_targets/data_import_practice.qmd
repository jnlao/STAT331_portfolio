...
ages <- read.csv(here::here("activities", "act1_readingInData", "Ages_Data", "ages.csv"))
...
ages_table <- read.table(here::here("activities", "act1_readingInData", "Ages_Data", "ages.csv"))
...
ages_myst <- read.delim(here::here("activities", "act1_readingInData", "Ages_Data", "ages_mystery.txt"), sep = "|")
...
ages_excel <- read_xlsx(here::here("activities", "act1_readingInData", "Ages_Data", "ages.xlsx"))
...
ages_data <- read.csv(here::here("activities", "act1_readingInData", "Ages_Data", "ages.csv"), stringsAsFactors = TRUE, header = FALSE, as.is = 2)
