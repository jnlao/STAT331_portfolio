...
ages <- read.csv(here::here("supporting_artifacts", 
                            "learning_targets", 
...
ages_table <- read.table(here::here("supporting_artifacts",
                                    "learning_targets", 
                                    "data_import_practice",
                                    "Ages_Data",
                                    "ages_tab.txt"))
...
ages_myst <- read.delim(here::here("supporting_artifacts", 
                                   "learning_targets",
                                   "data_import_practice",
                                   "Ages_Data", 
                                   "ages_mystery.txt"), 
...
ages_excel <- read_xlsx(here::here("supporting_artifacts", 
                                   "learning_targets",
                                   "data_import_practice",
                                   "Ages_Data", 
                                   "ages.xlsx"))
...
ages_data <- read.csv(here::here("supporting_artifacts",
                                 "learning_targets",
                                 "data_import_practice",
                                 "Ages_Data", 
                                 "ages.csv"), 
